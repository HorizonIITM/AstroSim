...
vector<valtype> cross_product(vector<valtype>v1, vector<valtype>v2) {
    vector<valtype> returned_result;
    returned_result.push_back(v1[1] * v2[2] - v1[2] * v2[1]);
    returned_result.push_back(v1[2] * v2[0] - v1[0] * v2[2]);
    returned_result.push_back(v1[0] * v2[1] - v1[1] * v2[0]);
