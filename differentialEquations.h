...
class AccelerationDerivative : public Derivative{
    public:
        AccelerationDerivative(GravitationalSystem&, short int&,GravitationalBody&);
        
        valtype operator() (valtype, valtype) const;
};

class Acceleration : public Derivative{
    public:
        Acceleration(GravitationalSystem&, short int&,GravitationalBody&);
